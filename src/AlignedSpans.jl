...
function start_index_from_time(sample_rate, span, mode::Union{RoundingMode{:Up},RoundingMode{:Down}})
...
function stop_index_from_time(sample_rate, span, mode::Union{RoundingMode{:Up},RoundingMode{:Down}})
